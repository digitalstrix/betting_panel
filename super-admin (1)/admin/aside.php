    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <a href="bets.php" aria-expanded="false" class="dropdown-toggle nav-link">
             ...
             <a href="withdrawls.php" aria-expanded="false" class="dropdown-toggle nav-link">
                <i class="fe fe-box fe-16"></i>
                <span class="ml-3 item-text">View Withdrawls</span>
            </a>
             <a href="addgame.php" aria-expanded="false" class="dropdown-toggle nav-link">
                <i class="fe fe-box fe-16"></i>
                <span class="ml-3 item-text">Add Game</span>
            </a>
