...
?>
                                ...
                                <div class="row align-items-center my-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total Master By You

                                                    </p>
                                                    <?php
                                                    $uuid = $_SESSION['userid'];
        $sql = "select * from users where user_type='master' AND created_by=$uuid";
       ...
       $pt = mysqli_num_rows($results);
        ?>
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total Users By You

                                                    </p>
                                                    <?php
        $sql = "select * from users where user_type='user' AND created_by=$uuid";
        $results = $connect->query($sql);
       $pt = mysqli_num_rows($results);
        ?>
                                                    <span class="h2 mb-0"><?php echo $pt; ?></span>
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Your Coin Balance

                                                    </p>
                                                    <?php
        $sql = "select user_coin from users where id=$uuid";
        $results = $connect->query($sql);
